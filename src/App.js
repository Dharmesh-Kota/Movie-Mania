...
class App extends Component {
  constructor () {
    ...
    this.state = {
      movies: [],
      initialMovies: ['Titanic', 'The Matrix', 'The Lion King', 'Inception', 'The Dark Knight', 
        'The Shawshank Redemption', 'The Godfather', 'The Avengers', 'Avengers: Age of Ultron',
        'Avengers: Infinity War', 'Avengers: Endgame', 'The Incredible'],
      searchField: ''
    }
  }
  ...
  componentDidMount() {
    const moviePromises = this.state.initialMovies.map(movie =>
      fetch(`https://api.themoviedb.org/3/search/movie?query=${movie}&api_key=c8ab0f0aac813aff5b5fa47908356f94`)
